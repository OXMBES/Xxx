"""
EXSLV — Report Generator Module
Author: Aceng-Hunter404 | YouTube: @Aceng-Hunter404
"""
...
<title>EXSLV — Security Report</title>
<style>
...
<header>
  <div>
    <div class="logo">👻 EXSLV<span>Advanced Android Pentesting Framework</span></div>
  </div>
  <div class="meta">
    <div class="target">{target}</div>
    <div>Generated: {timestamp}</div>
    <div>Report ID: {report_id}</div>
    <div>Author: Aceng-Hunter404 | @Aceng-Hunter404</div>
  </div>
</header>
<main>
...
<footer>
  <p>EXSLV &copy; 2026 | Author: <a href="https://www.YouTube.com/Aceng-Hunter404">Aceng-Hunter404</a> | For authorized use only</p>
</footer>
</body>
</html>
"""
...
def generate_html_report(data: dict, output: str = "EXSLV_report.html") -> str:
...
def generate_json_report(data: dict, output: str = "EXSLV_report.json") -> str:
    """Generate a structured JSON report."""
    report = {
        "tool": "EXSLV",
        "author": "Aceng-Hunter404 | @Aceng-Hunter404",
...
def print_summary_table(data: dict):
    ...
    t = Table(title="[bold magenta]📋 EXSLV — Findings Summary[/]",
